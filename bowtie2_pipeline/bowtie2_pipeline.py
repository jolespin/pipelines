...
def main(args=None):
    ...
    parser_required.add_argument("--ref_annotation",type=str, required=False, help="path/to/reference.gtf")
    ...
    parser_featurecounts.add_argument("--feature_type", type=str, default="exon", help = "Feature type in GTF/GFF file. Use 'CDS' for prodigal. Use 'gene' for prokaryotic genomes from NCBI. [Default: exon]")
